...
namespace TheBulbTunes
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Guid idOfFavouriteSong1 = new Guid("57029ed3-e5fe-467d-aa65-08d96238e7ac"); // All Over by Tiwa Savage
            Guid idOfFavouriteSong2 = new Guid("30bd68ae-7083-4603-aa69-08d96238e7ac"); // Essence by Wizkid
            Guid idOfFavouriteSong3 = new Guid("e58f9d01-f343-4fdb-aa66-08d96238e7ac"); // Nobody's Business by Rihanna

            // Set the id of user who wants to favourite a song
            Guid idOfUser1 = new Guid("56624948-0ed9-4681-dffc-08d96306324f"); // Philip Amadi
            Guid idOfUser2 = new Guid("76ffa97d-da37-42ca-dffe-08d96306324f"); // Bayowa Odometa
